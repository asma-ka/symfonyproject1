...
class RdvController extends AbstractController
{
    ...
    //         $rdvs= $this->getDoctrine()->getRepository(Rdv::class)->findBy(['numeroRdv' => $numeroRdv]);
    //          
    //         else
    ...
    //         
    //         }
    //         return $this->render('rdv/listes.html.twig',[ 
    ...
    // }
    /**
     *@Route("rdvs/affectation/{id}", name="rdv_affecter")
     */
    public function affectation( Rdv $rdv, Request $request){

        $prestataires = $this->getDoctrine()->getRepository(Prestataire::class)->findAll();
        if ($request->getMethod() == "POST"){
            $entityManager = $this->getDoctrine()->getManager();
        $prestataire= $this->getDoctrine()->getRepository(Prestataire::class)->find($request->request->get('prestataire'));
        ...
        return  $this->render('rdv/affecter.html.twig',[
    ...
    public function listRdv(RdvRepository $rdvRepository): Response
    {
        return $this->render('rdv/index.html.twig', [
            'rdvs' => $rdvRepository->findBy(["rdvStatus"=>RdvStatuType::CREE]),
        ]);
    }
    ...
    // $rdv->setNumeroRdv($request->request->get('nmrdv'));      
    ...
    public function delete(Request $request, Rdv $rdv): Response
    {
     ...
     /**
     * @Route("/intervention", name="intervention_listes", methods={"GET"})
     * @IsGranted("ROLE_USER")
     */
    public function indexinter(RdvRepository $rdvRepository): Response
    {
        return $this->render('intervention/listes.html.twig', [
     ...
     */
    public function listIntervention(RdvRepository $rdvRepository): Response
    {
        return $this->render('intervention/index.html.twig', [
            'interventions' => $rdvRepository->findBy(["rdvStatus"=>RdvStatuType::TRAITEE]),
        ]);
    }
